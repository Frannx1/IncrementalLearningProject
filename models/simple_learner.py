...
class SimpleLearner(MultiTaskLearner):
    ...
    def __init__(self, resnet_type="32", num_classes=10):
        super(SimpleLearner, self).__init__(resnet_type=resnet_type, num_classes=num_classes)
    ...
    def forward_and_compute_loss(self, images, labels):
        ...
        loss = classification_and_distillation_loss(    # It just use the classification loss
            outputs,
            labels,
        )
        return outputs, loss
